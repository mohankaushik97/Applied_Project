...
Xs = data.X_s_;
emg = data.RPECTORALISMAJOR_EMG1_V_;
emg_rms = data.RPECTORALISMAJOR_EMG1__filter_FilterSlidingRMS37__V_;
save('emg.mat', 'Xs', 'emg', 'emg_rms');

% Extract the desired columns as column matrices for 'acc.mat'
Xs_acc = data.X_s__3;
AccX = data.RLUMBRICAL_ACC_X2_g_;
AccY = data.RLUMBRICAL_ACC_Y2_g_;
AccZ = data.RLUMBRICAL_ACC_Z2_g_;
...
Xs_gaze = data.ComputerTimestamp;
gazeX = data.GazePointX;
gazeY = data.GazePointY;
